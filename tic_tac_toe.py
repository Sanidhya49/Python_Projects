...
optionFrame = Frame(root, bg="pale turquoise")
optionFrame.pack()
...
def changeModeToSinglePlayer():
  global mode
  mode = "singlePlayer"
  singlePlayerButton["bg"] = "SeaGreen3"
  multiPlayerButton["bg"] = "gray36"


def changeModeToMultiplayer():
  global mode
  mode = "multiPlayer"
  multiPlayerButton["bg"] = "SeaGreen3"
  singlePlayerButton["bg"] = "gray36"
